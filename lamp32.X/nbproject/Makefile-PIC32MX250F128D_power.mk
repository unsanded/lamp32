...
ifeq "$(wildcard nbproject/Makefile-local-PIC32MX250F128D_power.mk)" "nbproject/Makefile-local-PIC32MX250F128D_power.mk"
include nbproject/Makefile-local-PIC32MX250F128D_power.mk
endif
endif
...
# Macros
CND_CONF=PIC32MX250F128D_power
...
# Source Files
SOURCEFILES=main.cpp configuration_bits.cpp exceptions.cpp interrupts.cpp user.cpp debug.c cc3000.c cc3000_general.c cc3000_hci.c cc3000_network.c cc3000_nvmem.c cc3000_socket.c cc3000_spi.c cc3000_wlan.c spi_hw.c system.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-PIC32MX250F128D_power.mk dist/${CND_CONF}/${IMAGE_TYPE}/lamp32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/PIC32MX250F128D_power
	${RM} -r dist/PIC32MX250F128D_power
